        ...
        <div className="row mb-5">
          <div className="col-lg-6 mb-4">
            <div className="about-card mission-card">
              <h3>Our Mission</h3>
              <p>To provide a transformative educational experience that empowers students...</p>
            </div>
          </div>
          <div className="col-lg-6 mb-4">
            <div className="about-card vision-card">
              <h3>Our Vision</h3>
              <p>To be Papua New Guinea's leading private educational institution...</p>
            </div>
          </div>
        </div>
 {/* School History */}
        ...
        {/* You can include other sections here like Core Values, Leadership Team, etc. */}
    </section>
  );
};
